            ...
            <?php
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="HTC_Dashboard/img/tintuc/<?php echo $value['Anh']; ?>"></div>
                        <div class="blog__item__text">
                            <span><img src="img/icon/calendar.png" alt=""> <?php echo $value['NgayDang']; ?></span>
                                <h5><?php echo $value['TieuDe']; ?></h5>
                                <a href="blog-details.php?id=<?php echo $value['MaTT'] ?>">Đọc Thêm</a>
                        </div>
                    </div>
                </div>
                <?php
