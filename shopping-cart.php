                    ...
                    <div class="shopping__cart__table">
                        ...
                        ?>
                            <table>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="cart__close"><a href="shopping-cart.php?action=remove&MaSP=<?php echo $item["MaSP"]; ?>" class="btnRemoveAction"><i class="fa fa-close"></i></a></td>
                                        </tr>
                                    <?php
                                    ...
                                    <td colspan="6">
                                        <div class="continue__btn btn-empty">
                                            <a href="shopping-cart.php?action=empty" class="btn-empty">
                                ...
                                ?>
                                    <tr>
                                        <td colspan="6"><h5 class="empty">Giỏ hàng bạn trống!</h5></td>
                                    </tr>
                                <?php
                            }
                                ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="continue__btn update__btn">
                                <a href="checkout.php"><i class="fas fa-pound-sign"></i> Thanh Toán</a>
                            </div>
                        </div>
                    </div>
                </div>
